    ...
    foreach($rows as $row)
    {
        if(!$creature[$row['entry']])
        {
            if($row['DifficultyEntry2'])
            {
                ...
                if($normal_raid25['source_name'] == $normal_raid25['name'] && $row['name_loc'] != '')
                ...
                if($heroic_raid10['source_name'] == $heroic_raid10['name'] && $row['name_loc'] != '')
                ...
                if($row['DifficultyEntry3'])
                {
                    ...
                    if($heroic_raid25['source_name'] == $heroic_raid25['name'] && $row['name_loc'] != '')
            ...
            elseif($row['DifficultyEntry1'])
            {
                ...
                if($heroic_dungeon['source_name'] == $heroic_dungeon['name'] && $row['name_loc'] != '')
