...
cO(LANG, {
	...
	tc_unlearn: "Щелкните ПКМ, чтобы разучиться",
	tc_unlearn2: "Удерживая клавишу Shift, щелкните ПКМ, чтобы разучиться",
	tc_nextrank: "Следующий ранг:",
	...
	tc_remgly: "Щелкните ПКМ, чтобы удалить символ",
	tc_remgly2: "Нажмите Shift+ЛКМ, чтобы удалить",
	tc_nonegly: "Без символа",
	alert_invalidurl: "Неверная ссылка.",
	alert_chooseclass: "Выберите класс.",
	alert_choosefamily: "Выберите породу животного.",
