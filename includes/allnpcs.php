...
$npc_cols[1] = array('name', 'SubName', 'MinLevel', 'MaxLevel', 'CreatureType', 'UnitClass', 'Rank', 'MinLootGold', 'MaxLootGold', 'LootId', 'SkinningLootId', 'PickpocketLootId', 'MinMeleeDmg', 'MaxMeleeDmg', 'MeleeAttackPower', 'HealthMultiplier', 'PowerMultiplier', 'DamageMultiplier', 'DamageVariance', 'Armor', 'MeleeBaseAttackTime', 'RangedBaseAttackTime', 'DifficultyEntry1', 'DifficultyEntry2', 'DifficultyEntry3', 'Expansion');
