...
switch($_SESSION['locale'])
{
    ...
    case '8':
        mass_define(array(
            ...
            'LOCALE_QUEST_FLAGS_HIDDEN_REWARDS'    => 'Награда видна только по окончании',
            ...
            'LOCALE_QUEST_SPECIALFLAGS_MONTHLY'    => 'Ежемесячный',
            ...
            // reputation
            'LOCALE_REPUTATION_WITH'   => 'Репутация c',
            ...
            'LOCALE_HATED'             => 'Ненависть',
            'LOCALE_HOSTILE'           => 'Враждебность',
            'LOCALE_UNFRIENDLY'        => 'Неприязнь',
            // resistances
            ...
            'LOCALE_BAG_LEATHER'  => 'Сумка для кожевничества',
            'LOCALE_BAG_HERB'     => 'Сумка для травничества',
            'LOCALE_BAG_ENCHANT'  => 'Сумка для наложения чар',
            'LOCALE_BAG_ENGINEER' => 'Сумка для инженерного дела',
            'LOCALE_BAG_GEM'      => 'Сумка для ювелирного дела',
            'LOCALE_BAG_MINING'   => 'Сумка для горного дела',
            // equip slots
            ...
            // stats
            'LOCALE_SET_BONUS'      => 'Комплект',
            'LOCALE_ITEM_QUANTITY1' => 'предмета',
            'LOCALE_ITEM_QUANTITY2' => 'предметов',
            'LOCALE_STAT_STRENGTH'  => ' к силе',
            'LOCALE_STAT_STAMINA'   => ' к выносливости',
            'LOCALE_STAT_INTELLECT' => ' к интеллекту',
            'LOCALE_STAT_SPIRIT'    => ' к духу',
            'LOCALE_STAT_AGILITY'   => ' к ловкости',
            // green bonuses
            'LOCALE_GBONUS_DEFENCE'           => 'Рейтинг защиты +%d',
            'LOCALE_GBONUS_DODGE'             => 'Рейтинг уклонения +%d',
            'LOCALE_GBONUS_PARRY'             => 'Рейтинг парирования +%d',
            'LOCALE_GBONUS_SHIELDBLOCK'       => 'Рейтинг блокирования щитом +%d',
            ...
            'LOCALE_GBONUS_RANGEDATTACKPOWER' => 'Сила атаки дальнего боя +%d',
            'LOCALE_GBONUS_FERALATTACKPOWER'  => 'Сила атаки в форме зверя +%d (друид)',
            'LOCALE_GBONUS_ARMORPENETRATION'  => 'Рейтинг пробивания брони +%d',
            'LOCALE_GBONUS_SPELLPOWER'        => 'Сила заклинаний +%d',
            'LOCALE_GBONUS_HEALTHREGEN'       => 'Восстанавливает %d здоровья за 5 сек.',
            'LOCALE_GBONUS_SPELLPENETRATION'  => 'Проникающая способность заклинаний +%d',
            'LOCALE_GBONUS_BLOCK'             => 'Рейтинг блока щита +%d',
            ...
            'LOCALE_REQUIRES_LEVEL1' => 'Требуется',
            'LOCALE_REQUIRES_LEVEL2' => 'уровень',
            ...
            'LOCALE_SCHOOL_MASK_FIRE'     => 'Огонь',
            'LOCALE_SCHOOL_MASK_NATURE'   => 'Природа',
            ...
            'LOCALE_POWER_HAPPINESS'      => 'Действие эликсира',
            'LOCALE_RUNE'                 => 'руна',
            'LOCALE_RUNES1'               => 'руны',
            'LOCALE_RUNES2'               => 'рун',
            'LOCALE_BLOOD_RUNE'           => 'крови',
            'LOCALE_UNHOLY_RUNE'          => 'нечестивости',
            'LOCALE_FROST_RUNE'           => 'льда',
    ...
    case '3':
        mass_define(array(
            ...
            'LOCALE_QUEST_FLAGS_EVENT'             => '[Suggested to all party members]',
            ...
            'LOCALE_QUEST_FLAGS_FLAGS_PVP'         => '[PvP]',
            'LOCALE_QUEST_FLAGS_WEEKLY'            => '[Weekly quest]',
            'LOCALE_QUEST_FLAGS_AUTOCOMPLETE'      => '[Auto complete]',
            'LOCALE_QUEST_FLAGS_UNK5'              => '[Item is issued/required]',
            'LOCALE_QUEST_FLAGS_AUTO_ACCEPT'       => '[Starting areas]',
            'LOCALE_QUEST_SPECIALFLAGS_REPEATABLE' => '[Repeatable]',
            'LOCALE_QUEST_SPECIALFLAGS_SCRIPTED'   => '[Completed only by script/event]',
            'LOCALE_QUEST_SPECIALFLAGS_MONTHLY'    => '[Monthly quest]',
            ...
            'LOCALE_ORC'           => 'Orc',
            'LOCALE_DWARF'         => 'Zwerg',
            'LOCALE_NIGHTELF'      => 'Nachtelf',
            'LOCALE_UNDED'         => 'Untoter',
            'LOCALE_TAUREN'        => 'Taure',
            'LOCALE_GNOME'         => 'Gnom',
            'LOCALE_TROLL'         => 'Troll',
            'LOCALE_BLOODELF'      => 'Butelf',
            ...
            // reputation
            'LOCALE_REPUTATION_WITH'   => 'Ruf mit der',
            ...
            'LOCALE_HATED'             => 'Hasserfüllt',
            'LOCALE_HOSTILE'           => 'Feindselig',
            'LOCALE_UNFRIENDLY'        => 'Unfreundlich',
            // resistances
            ...
            'LOCALE_ITEM_QUANTITY1' => 'items',
            'LOCALE_ITEM_QUANTITY2' => 'items',
            ...
            'LOCALE_GBONUS_RANGEDATTACKPOWER' => 'Ranged attack power +%d',
            'LOCALE_GBONUS_FERALATTACKPOWER'  => 'Feral attack power +%d',
            'LOCALE_GBONUS_ARMORPENETRATION'  => 'Erhöht Euren Rüstungsdurchschlagwert um %d.',
            'LOCALE_GBONUS_SPELLPOWER'        => 'Erhöht Zauberkraft um %d.',
            'LOCALE_GBONUS_HEALTHREGEN'       => 'Stellt alle 5 Sek. %d Gesundheit wieder her.',
            'LOCALE_GBONUS_SPELLPENETRATION'  => 'Erhöht den Zauberdurchschlag um %d.',
            'LOCALE_GBONUS_BLOCK'             => 'Erhöht Blockwert um %d.',
            ...
            'LOCALE_REQUIRES_LEVEL1' => 'Benötigt',
            'LOCALE_REQUIRES_LEVEL2' => 'Stufe',
            ...
            'LOCALE_SCHOOL_MASK_FIRE'     => 'Feuer',
            'LOCALE_SCHOOL_MASK_NATURE'   => 'Natur',
            ...
            'LOCALE_POWER_HAPPINESS'      => 'Effect of elixir',
            'LOCALE_RUNE'                 => 'rune',
            'LOCALE_RUNES1'               => 'runes',
            'LOCALE_RUNES2'               => 'runes',
            'LOCALE_BLOOD_RUNE'           => 'of blood',
            'LOCALE_UNHOLY_RUNE'          => 'of unholy',
            'LOCALE_FROST_RUNE'           => 'of frost',
    ...
    case '2':
        mass_define(array(
            ...
            'LOCALE_QUEST_FLAGS_EVENT'             => 'Proposé à tous les membres du parti',
            ...
            'LOCALE_ORC'           => 'Orc',
            'LOCALE_DWARF'         => 'Nain',
            'LOCALE_NIGHTELF'      => 'Elfe de la nuit',
            'LOCALE_UNDEAD'        => 'Mort-vivant',
            'LOCALE_TAUREN'        => 'Tauren',
            'LOCALE_GNOME'         => 'Gnome',
            'LOCALE_TROLL'         => 'Troll',
            'LOCALE_BLOODELF'      => 'Elfe de sang',
            'LOCALE_DRAENEI'       => 'Draenei',
            // side
            ...
            // reputation
            'LOCALE_REPUTATION_WITH' => 'Réputation avec',
            'LOCALE_NEUTRAL'         => 'Neutre',
            'LOCALE_FRIENDLY'        => 'Amical',
            'LOCALE_HONORED'         => 'Honoré',
            'LOCALE_REVERED'         => 'Révére',
            'LOCALE_EXALTED'         => 'Exalté',
            'LOCALE_HATED'           => 'Détesté',
            'LOCALE_HOSTILE'         => 'Hostile',
            'LOCALE_UNFRIENDLY'      => 'Inamical',
            // resistances
            ...
            'LOCALE_GBONUS_HEALTHREGEN'       => 'Rend %d points de vie toutes les 5 secondes.',
            'LOCALE_GBONUS_SPELLPENETRATION'  => 'Augmente la pénétration des sorts de %d.',
            'LOCALE_GBONUS_BLOCK'             => 'Augmente la valeur de blocage de %d.',
            ...
            'LOCALE_REQUIRES_LEVEL1' => 'Requis',
            'LOCALE_REQUIRES_LEVEL2' => 'niveau',
            ...
            'LOCALE_SCHOOL_MASK_FIRE'     => 'Feu',
            'LOCALE_SCHOOL_MASK_NATURE'   => 'Nature',
    ...
    default:
        mass_define(array(
            ...
            'LOCALE_ORC'           => 'Orc',
            'LOCALE_DWARF'         => 'Dwarf',
            'LOCALE_NIGHTELF'      => 'Night Elf',
            'LOCALE_UNDEAD'        => 'Undead',
            'LOCALE_TAUREN'        => 'Tauren',
            'LOCALE_GNOME'         => 'Gnome',
            'LOCALE_TROLL'         => 'Troll',
            'LOCALE_BLOODELF'      => 'Blood Elf',
            'LOCALE_DRAENEI'       => 'Draenei',
            // side                
            ...
            'LOCALE_ALLIANCE'      => 'Alliance',
            // reputation
            'LOCALE_REPUTATION_WITH' => 'Reputation with',
            'LOCALE_NEUTRAL'         => 'Neutral',
            ...
            'LOCALE_REQUIRES_LEVEL1' => 'Requires',
            'LOCALE_REQUIRES_LEVEL2' => 'Level',
