...
switch($_SESSION['locale'])
{
	...
	case '8':
		mass_define(array(
			...
			'LOCALE_GBONUS_DODGE'			   	=>	'Вероятность уклонения +%d',
			'LOCALE_GBONUS_PARRY'			   	=>	'Вероятность парирования +%d',
			'LOCALE_GBONUS_SHIELDBLOCK'		 	=>	'Вероятность блокирования +%d',
			...
			'LOCALE_ARMOR'		  		=>	'Броня',
			'LOCALE_BLOCK'		  		=>	'Шанс блокирования',
