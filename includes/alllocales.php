...
switch($_SESSION['locale'])
{
    ...
    case '8':
        mass_define(array(
            ...
            'LOCALE_GBONUS_DODGE'               =>    'Уклонение +%d',
            'LOCALE_GBONUS_PARRY'               =>    'Парирование +%d',
            'LOCALE_GBONUS_SHIELDBLOCK'         =>    'Блокирование +%d',
            'LOCALE_GBONUS_SPELLHIT_RATING'     =>    'Рейтинг меткости при использовании заклинаний +%d',
            ...
            'LOCALE_GBONUS_SPELLCRIT_RATING'    =>    'Рейтинг критического удара при использовании заклинаний +%d',
            'LOCALE_GBONUS_SPELLHASTE_RATING'   =>    'Рейтинг скорости при использовании заклинаний +%d',
            'LOCALE_GBONUS_HIT_RATING'          =>    'Рейтинг меткости +%d',
            'LOCALE_GBONUS_CRIT_RATING'         =>    'Рейтинг критического удара +%d',
            'LOCALE_GBONUS_RESILIENCE_RATING'   =>    'Рейтинг стойкости +%d',
